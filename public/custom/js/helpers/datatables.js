(function ($) {
  ...
  $.fn.myDataTable = function (options) {
    ...
    var defaults = {
      url:
        typeof object.attr("data-table-source") !== "undefined"
          ? object.attr("data-table-source")
          : null,
      ordering:
        typeof object.attr("data-table-ordering") !== "undefined"
          ? object.attr("data-table-ordering")
          : false,
      filter: true,
      lengthChange: true,
      filterData:
        typeof object.attr("data-table-filter") !== "undefined"
          ? object.attr("data-table-filter")
          : false,
      columns: null,
      columnDefs: [
        {
      ...
      columnIndex:
        typeof $("th.num-rows", object) !== "undefined"
          ? $("th.num-rows", object).index()
          : null,
      paging:
        typeof object.attr("data-table-paging") !== "undefined"
          ? object.attr("data-table-paging")
          : "true",
      info:
        typeof object.attr("data-table-info") !== "undefined"
          ? object.attr("data-table-info")
          : "true",
    ...
    var dataTable = object.DataTable({
      ...
      fnInitComplete: function () {
        ...
        $(this)
          .find("[data-sorting = false]")
          .attr("class", "sorting_disabled");
        $('[rel="tooltip"]').tooltip();
      ...
      rowCallback: function (row, data, displayNum) {
        ...
        if (typeof data.checkbox != "undefined") {
          ...
          box.append(
            '<input type="checkbox" class="custom-control-input dt-checkbox" id="cb-' +
              displayNum +
              '" name="_id[]" ' +
              disabled +
              ' value="' +
          ...
          $.each(options.actions, function (idx, val) {
            ...
            if (typeof val.id != "undefined") {
              ...
              def = {
                ...
                title:
                  typeof val.title != "undefined" ? val.title : __("Button"),
                className:
                  typeof val.className != "undefined"
                    ? val.className
                    : "btn btn-secondary",
                modal:
                  typeof val.modal != "undefined" ? val.modal : "#modal-md",
                toggle:
                  typeof val.toggle != "undefined"
                    ? val.toggle
                    : "modal-detail",
              };
            }
